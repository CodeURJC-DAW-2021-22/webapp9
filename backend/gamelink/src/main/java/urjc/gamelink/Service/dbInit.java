...
public class dbInit {
	...
	public void init() throws IOException, URISyntaxException {
        ...
        */
        ...
        ArrayList<Videogame> videojuegoscomprados = new ArrayList<>();
        videojuegoscomprados.add(vg20);
        videojuegoscomprados.add(vg2);
        videojuegoscomprados.add(vg5);
        videojuegoscomprados.add(vg20);
        videojuegoscomprados.add(vg15);
        usr.setpurchaseVideogames(videojuegoscomprados);
        ArrayList<String> roles2 = new ArrayList<>();
        roles2.add("USERO");
        usr2.setRoles(roles2);
        usr2.setpurchaseVideogames(videojuegoscomprados);
        us.save(usr2);
